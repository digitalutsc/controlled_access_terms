...
/**
 * Allows indexing of reverse Typed Relation references.
 *
 * @SearchApiProcessor(
 *   id = "reverse_typerelation_references",
 *   label = @Translation("Reverse Typed Relation references"),
 ...
 * )
 */
class ReverseTypedRelationReferences extends ProcessorPluginBase {

  /**
   * Static cache for all Typed Relation references.
   *
   * @var array[][]|null
   *
   * @see \Drupal\search_api\Plugin\search_api\processor\ReverseEntityReferences::getTypedRelationReferences()
   */
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    $references = $this->getTypedRelationReferences();
  ...
  /**
   * Collects all Typed Relation references.
   *
   * @return array[][]
   ...
   */
  public function getTypedRelationReferences() {
    ...
    if (isset($cache->data)) {
      ...
      foreach ($entity_types as $entity_type_id => $entity_type) {
        ...
        foreach ($properties as $name => $property) {
          if ($property->getType() !== 'typed_relation') {
            continue;
          }
